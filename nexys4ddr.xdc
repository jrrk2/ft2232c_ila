...
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports BT_MISO]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports BT_MOSI]
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports BT_SCK]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports BT_CS]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets UART_RTS]
